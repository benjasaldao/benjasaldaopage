      ...
      <div className="text-xl h-screen flex flex-col items-center justify-evenly">
        ...
        <div className="flex sm:flex-row flex-col items-center justify-center">
          <Link passHref href="#about-me">
            <button className="px-7 hover:bg-indigo-600 py-1 rounded-md text-white bg-primary m-4 md:mr-16">Sobre mi</button>
          </Link>
          <Link passHref href="#contact">
            <button className="px-7 hover:bg-indigo-200 py-1 rounded-md text-black border-2 border-primary m-4 md:mr-16">Contacto</button>
          </Link>
        </div>
      </div>
    </div>
