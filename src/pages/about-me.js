    ...
    <Container>
      ...
      <div className="text-gray-500">
        ...
        <p>
          ...
          utilizada en muchos ambitos, incluso hasta en la robotica. En mi caso la utilizo para añadirle funcionalidades a mis sitios y luego la llevo al lado del servidor para utilizarla de una
          infinidad de maneras. Actualmente trabajo en una distribuidora de telas (donde no hago nada relacionado a la programacion), y en mi tiempo libre me dedico a seguir aprendiendo a programar,
          ya que el constante cambio en el sector tecnologico hace que nunca termines de aprender.
        </p>
      </div>
      ...
      <p>
        ...
        poder desarrollar APIs REST. Ademas se utilizar Next JS para implementar server side render y poder transformar dicha web en una progresive web app, una aplicacion creada con tecnologias web
        pero que funciona como una aplicacion de escritorio.
      </p>
