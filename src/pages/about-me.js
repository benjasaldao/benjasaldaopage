    ...
    <Container>
      ...
      <div className="text-gray-500">
        ...
        <p>
          ...
          utilizada en muchos ambitos, incluso hasta en la robotica. Pero yo no se nada de robotica, en mi caso la utilizo para añadirle funciones a mis paginas y luego la llevo al lado del servidor
          para utilizarla de una infinidad de maneras. Actualmente trabajo en una distribuidora de telas (donde no hago nada relacionado a la programacion), y en mi tiempo libre me dedico a seguir
          aprendiendo a programar, ya que el constante cambio en el sector tecnologico hace que nunca termines de aprender. Te dejo links a mis redes sociales por si queres conocerme mas de cerca!
        </p>
      ...
      <p>
        ...
        poder desarrollar APIs REST. Ademas se utilizar Next JS para implementar server side render y ademas transformar dicha web en una progresive web app.
      </p>
